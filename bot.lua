wpackage.path = package.path .. ';.luarocks/share/lua/5.2/?.lua'
...
if input:match("^[#!/][Hh]elp$") and is_mod(msg) or input:match("^[Hh]elp$") and is_mod(msg) or input:match("^راهنما$") and is_mod(msg) then
        local text = "🏅`اهنماي فارسي انگليسي ورژن 1.0.`:".."\n"
	.."🏅قفل ها:\n"
...
if input:match("^[#!/][Jj][Oo][Vv][Ee]$") and is_mod(msg) or input:match("^[Jj][Oo][Vv][Ee]$") and is_mod(msg) or input:match("^تی دی$") and is_mod(msg) then
        local text = "🏅 ربات تی دی با افتخار تقدیم میکند: \n"
	.." تی دی رباتی قدرتمند جهت مدیریت سکوت: \n"
        ...
        .."🏅  ديباگ شده و قدرتمند \n"
        .."🏅  کانال رسمي: @tdTeam \n"
        .."🏅  پيام رسان: @PvtdTeamBot \n"
        .."🏅 سرور: #Hetzner \n"
        .."🏅 رم: 16Gig \n"
        .."🏅 پشتيباني: tdteam-co.ir \n"
        .." ................................. "
        tdcli.sendText(chat_id, msg.id_, 0, 1, nil, text, 1, 'md')
      end
